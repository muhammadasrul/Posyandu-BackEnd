      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <?php if ($posyandu_id = $this->session->userdata("posyandu_id") == null) {
              echo '<li class="';
              echo $this->uri->segment(2) == "blog" ? "active" : "";
              echo '"><a class="nav-link" href="'.base_url("admin/blog").'"><i class="far fa-newspaper"></i> <span>Blog</span></a></li>';
            }?>
